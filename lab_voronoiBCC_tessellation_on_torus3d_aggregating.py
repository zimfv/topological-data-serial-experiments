...
input_filename = 'lab-results/lab_voronoiBCC_tessellation_on_torus3d/size{0}_exp{1}.csv'
output_filename = 'lab-results/lab_voronoiBCC_tessellation_on_torus3d_aggregated/size{0}.csv'
