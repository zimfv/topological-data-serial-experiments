...
sizes = np.arange(2, 70)
experiments = np.arange(100)

input_filename = 'lab-results/lab_cubical_tessellation_on_torus3d/size{0}_exp{1}.csv'
output_filename = 'lab-results/lab_cubical_tessellation_on_torus3d_aggregated/size{0}.csv'
