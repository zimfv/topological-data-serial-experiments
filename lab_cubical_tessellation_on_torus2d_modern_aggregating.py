...
input_filename = 'lab-results/lab_cubical_tessellation_on_torus2d_modern/size{0}_exp{1}.csv'
output_filename = 'lab-results/lab_cubical_tessellation_on_torus2d_modern_aggregated/size{0}.csv'
